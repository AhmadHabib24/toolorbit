...
@section('title', 'Base64 Encoder/Decoder - ToolOrbit')
@section('meta_description', 'Easily encode or decode text to and from Base64 format. Fast, secure, and completely free online tool.')

@section('content')
<x-tool-layout 
    title="Base64 Encoder/Decoder" 
    description="Transform your text into Base64 format or decode it back to plain text."
...
>
    <div x-data="{ 
        ...
        async process() {
            ...
            try {
                const response = await fetch('/security/base64-encoder-decoder', {
                    method: 'POST',
                    headers: {
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-2">Input Text:</label>
                    <textarea 
                        x-model="input" 
                        @input="process()"
                        rows="12" 
